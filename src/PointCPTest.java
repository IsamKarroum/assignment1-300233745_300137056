...
public class PointCPTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter The design you wish to test");
		...
		if (n == 1) {
			...
			System.out.println("\nYou entered:\n" + point2);
			System.out.println("\nAfter asking to store as Polar:\n" + point2);
			System.out.println("\nAfter asking to store as Cartesian:\n" + "Stored as Polar, Cartesian Equivalent: (" + point2.getX() + "," + point2.getY() + ")");
		} else if (n == 3) {
			try {
				point3 = new PointCP3(args[0].toUpperCase().charAt(0), Double.valueOf(args[1]).doubleValue(),
						Double.valueOf(args[2]).doubleValue());
			} catch (Exception e) {
				// If we arrive here, it is because either there were no
				// command line arguments, or they were invalid
			...
			System.out.println("\nYou entered:\n" + point3);
			System.out.println("\nAfter asking to store as Cartesian:\n" + point3);
			System.out.println("\nAfter asking to store as Polar:\n" + "Stored as Cartesian, Polar Equivalent: [" + point3.getRho() + "," + point3.getTheta()+ "]");
		}
	}
	...
	private static PointCP2 getInput2() throws IOException {
		...
		for (int i = 0; i < 3; i++) {
			while (!(isOK)) {
				...
				if (i == 0) // First argument - type of coordinates
				{
					System.out.print("Enter the type of Coordinates you " + "are inputting ((P)olar): ");
				} else // Second and third arguments
				{
					System.out.print("Enter the value of "
							+ (coordType == 'C' ? (i == 1 ? "X " : "Y ") : (i == 1 ? "Rho " : "Theta "))
	...
	private static PointCP3 getInput3() throws IOException {
		...
		for (int i = 0; i < 3; i++) {
			while (!(isOK)) {
				...
				if (i == 0) // First argument - type of coordinates
				{
					System.out.print("Enter the type of Coordinates you " + "are inputting ((C)artesian): ");
				} else // Second and third arguments
				{
					System.out.print("Enter the value of "
							+ (coordType == 'C' ? (i == 1 ? "X " : "Y ") : (i == 1 ? "Rho " : "Theta "))
